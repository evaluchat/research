...
AI may draft structure, check completeness, and prepare review packets. AI may not make ethical or scientific decisions, list itself as author, fabricate participants, data, quotations, results, or reviewer approval, or present a load-bearing claim. Humans remain accountable for consent, participant inclusion, interpretation, publication status, and any claim.
